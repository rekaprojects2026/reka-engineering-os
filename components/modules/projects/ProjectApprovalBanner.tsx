            ...
            {showReject ? (
              <div className="min-w-0 flex-1 space-y-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-[0.8125rem] outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
